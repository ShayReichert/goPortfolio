...
func nav() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<!--begin navbar --><header class=\"header\"><!--begin nav --><nav class=\"navbar navbar-default navbar-fixed-top\"><!--begin container --><div class=\"container\"><!--begin navbar --><div class=\"navbar-header\"><button data-target=\"#navbar-collapse-02\" data-toggle=\"collapse\" class=\"navbar-toggle\" type=\"button\"><span class=\"sr-only\">Toggle navigation</span> <span class=\"icon-bar\"></span> <span class=\"icon-bar\"></span> <span class=\"icon-bar\"></span></button> <a href=\"/\" class=\"navbar-brand brand scrool\"><span class=\"blue\">Alexis</span> Mathiot</a></div><div id=\"navbar-collapse-02\" class=\"collapse navbar-collapse\"><ul class=\"nav navbar-nav navbar-right\"><li><a href=\"#home_wrapper\">A Propos</a></li><li><a href=\"#competences\">Compétences</a></li><li><a href=\"#portfolio\">Portfolio</a></li><li><a href=\"#contact\" class=\"purchase scrool\">Contact</a></li></ul></div><!--end navbar --></div><!--end container --></nav><!--end nav --></header><!--end navbar -->")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if !templ_7745c5c3_IsBuffer {
...
func hero() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<section id=\"home_wrapper\" class=\"home-wrapper\"><!--begin gradient_overlay --><div class=\"gradient_overlay\"></div><!--end gradient_overlay --><!--begin container--><div class=\"container home-wrappe-inside\"><!--begin row--><div class=\"row margin-bottom-30 justify-content-center\"><!--begin col-md-6--><div class=\"col-md-10 padding-top-20\"><h2 class=\"home-title wow fadeIn\" data-wow-delay=\"0.25s\">Alexis Mathiot</h2><h1 class=\"home-title wow fadeIn\" data-wow-delay=\"0.25s\">Développeur Web spécialisé en PHP et Symfony</h1></div><!--end col-md-6--></div><!--end row--></div><!--end container--></section>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if !templ_7745c5c3_IsBuffer {
